...
<div class="row_1-container">
  ...
  <div class="navigation-links">
    ...
    <li><a href="#">Orders Completed</a></li>
  </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <?php
                           $query = "SELECT * FROM cart where client='$username'";
                        ...
                        ?>
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                              <td class="img"><img src=<?php echo $location.$row["image"];?>> </td>
                                     <td class="column"><?php  echo $row['uname']; ?></td>
                                             <td class="column"><?php  echo $row['date']; ?></td>
                                               <td class="column">
                                                   <?php
                                                       $num_format = number_format($result, 2,'.',',');
                                                       echo "&#8369; ",$num_format;
                                                   ?>
                                               </td>
                                            <td class="column">
                                        ...
                                        <td>
                                            <div class="fifth-col">
                                                  <div class="btn-delete">
                                                       <a href="MyOrderDeleteCart.php?p_id=<?php echo $row["c_id"]; ?>">
                                                       <i class="far fa-trash-alt"></i>
                                                        </a>
                                                  </div>
                                                     <div>
                                                         <button type="submit" name="btn-update" <i style="font-size: 23px;" class="far fa-edit"></button>
                                                     </div>
