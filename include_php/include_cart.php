  ...
  <!--<span style="font-size:25px; color:blue"><center><strong>PHP/MySQLi CRUD Operation using Bootstrap</strong></center></span> -->
    ...
    <table class="table table-striped table-bordered table-hover">
      ...
      <?php
        ...
        $query=mysqli_query($connection,"select * from `cart` where client='$client_name'");
           ...
           <?php
            ...
            <td>
              ...
              <?php //include('button.php'); ?>-->
                <button type="submit" name="btn-update">Edit</button>
               <a class="edit" href="delete_cart_process.php?id=<?php echo $row["c_id"];?>">Delete</a>
                <?php
                ...
                <a class="delete" href="#del<?php echo $row['c_id']; ?>"data-toggle="modal"></a>
...
<div class="total">
  <div class="label">
     ...
     <h3 style="color:red">Grand Total:
      <?php
