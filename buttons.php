 <?php
   ...
   if(isset($_POST['btn'])){
    ...
    if($sqlCreate)
    {
         echo "<script>if(confirm('Successfully Updated !')){document.location.href='history.php'};</script>";
            exit();
    }
...
<!-- Delete -->
    <div class="modal fade" id="del<?php echo $row['buy']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
				<?php
					$del=mysqli_query($connection,"select * from cart where c_id='".$row['buy']."'");
