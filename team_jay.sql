...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2021 at 02:54 PM
...
INSERT INTO `buy` (`buy`, `uname`, `price`, `quantity`, `image`, `client`, `stock`, `stock2`, `product_id`, `date`, `status`) VALUES
(3, 'Steamed Rice Deedpangs', '55.00', 2, 'SteamedRiceDeedpangs.jpg', 'jayjay', 15, 17, 123, '10-23-21', 'Done'),
(4, 'Bottled Cold Brew Coffees', '100.00', 1, 'BottledColdBrewCoffees.jpg', 'jayjay', 18, 19, 124, '11-05-21', 'Canceled'),
(5, 'Bottled Cold Brew Coffees', '100.00', 1, 'BottledColdBrewCoffees.jpg', 'jayjay', 17, 18, 124, '11-05-21', 'Canceled'),
(6, 'Bottled Cold Brew Coffees', '100.00', 1, 'BottledColdBrewCoffees.jpg', 'jayjay', 16, 17, 124, '11-05-21', 'Canceled'),
(7, 'Boba MilkTea', '75.00', 1, 'MilkTeaBobaTeaio.jpg', 'jayjay', 19, 20, 125, '11-29-21', 'Pending');
...
(508, 'Steamed Rice Deedpangs', '55.00', 1, 'SteamedRiceDeedpangs.jpg', 'jayjay', 16, 17, 123, '11-05-21'),
(509, 'Monster D', '160.00', 1, 'MonsterDCityBurger.jpg', 'jayjay', 19, 20, 127, '11-29-21');
...
(113, 'jayjay', 'c4ca4238a0b923820dcc509a6f75849b', 'Malingin', '', '2000-05-19', 'Jay', 'Catadmans', '09977784168', 'J.png', 'none', 'none'),
(114, 'store1', '4297f44b13955235245b2497399d7a93', 'null', 'null', '2020-09-03', 'null', 'null', '0', '', 'Store1', 'admin');
...
(123, 'Steamed Rice Deedpangs', '55.00', 'null', 16, 'SteamedRiceDeedpangs.jpg', 1, 'Kaon na Langging'),
(124, 'Bottled Cold Brew Coffees', '100.00', 'null', 17, 'BottledColdBrewCoffees.jpg', 0, 'Kaon na Langging'),
(125, 'Boba MilkTea', '75.00', 'null', 19, 'MilkTeaBobaTeaio.jpg', 1, 'Boba Teaio'),
(126, 'Ochado MilkTea', '75.00', 'null', 20, 'MilkTeaOchado.jpg', 0, 'Ochado'),
(127, 'Monster D', '160.00', 'null', 20, 'MonsterDCityBurger.jpg', 1, 'Kaon na Langging');
...
(175, 2, 'hala', 'J.png', 'jayjay', 'Steamed Rice Deedpangs', 123),
(176, 1, 'what the', 'J.png', 'jayjay', 'Steamed Rice Deedpangs', 123),
(177, 4, 'asdasdasd', 'J.png', 'jayjay', 'Bottled Cold Brew Coffees', 124);
...
--
ALTER TABLE `buy`
  MODIFY `buy` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `cart`
--
ALTER TABLE `cart`
  MODIFY `c_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=510;
...
--
ALTER TABLE `product`
  MODIFY `p_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
...
--
ALTER TABLE `rating`
  MODIFY `r_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=178;
